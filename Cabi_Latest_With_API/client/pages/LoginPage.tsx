...
export default function LoginPage() {
  ...
  const { login, register, sendVerificationEmail, verifyOTP, loginWithGoogle, resetPassword } = useAuth();
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                  ...
                  <div className="relative">
                    <div className="absolute inset-0 flex items-center">
                      <span className="w-full border-t border-cabinet-yellow/20" />
                    </div>
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-background px-2 text-cabinet-grey">Or continue with</span>
                    </div>
                  </div>
                  ...
                  <Button
                    ...
                    disabled={isLoading}
                    className="w-full border-cabinet-yellow/30 text-cabinet-yellow hover:bg-cabinet-yellow/10 font-semibold py-3"
                  >
                  ...
                  <div className="text-center">
                    <Button
                      ...
                      className="text-cabinet-yellow hover:text-cabinet-light-yellow text-sm"
                    >
